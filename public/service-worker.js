const CACHE_NAME = 'app-territorios-v3.2.0';
const ASSETS_TO_CACHE = [
    ...
    '/data/firestore-services.js?v=3.2.0',
    '/modules/login.js?v=3.2.0',
    '/modules/admin-dashboard.js?v=3.2.0',
    '/modules/conductor-dashboard.js?v=3.2.0',
    '/modules/report-s13.js?v=3.2.0',
    '/modules/analytics-view.js?v=3.2.0',
    '/modules/utils/helpers.js?v=3.2.0',
    '/modules/utils/intelligence.js?v=3.2.0',
    '/modules/map-viewer.js?v=3.2.0',
    '/modules/utils/theme-manager.js?v=3.2.0',
    '/public/icon-192.svg',
    '/public/icon-512.svg',
    '/public/favicon.svg',
