const CACHE_NAME = 'xolu-premium-v1.9.8.5';

const ASSETS_CORE = [
    '/',
    '/index.html',
    '/styles.css?v=1.9.8.5',
    '/app.js?v=1.9.8.5',
    '/manifest.json',
    '/firebase-config.js?v=1.9.8.5',
    '/data/firestore-services.js?v=1.9.8.5',
    '/modules/login.js?v=1.9.8.5',
    '/modules/admin-dashboard.js?v=1.9.8.5',
    '/modules/conductor-dashboard.js?v=1.9.8.5',
    '/modules/report-s13.js?v=1.9.8.5',
    '/modules/analytics-view.js?v=1.9.8.5',
    '/modules/utils/helpers.js?v=1.9.8.5',
    '/modules/utils/intelligence.js?v=1.9.8.5',
    '/modules/map-viewer.js?v=1.9.8.5',
    '/modules/utils/theme-manager.js?v=1.9.8.5',
    '/favicon.svg',
    '/icon-192.svg',
    '/icon-512.svg'
];
