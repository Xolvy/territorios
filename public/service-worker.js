const CACHE_NAME = 'territorios-elite-v2.1.2';
...
const ASSETS_CORE = [
    ...
    '/data/firestore-services.js?v=2.1.2',
    '/modules/login.js?v=2.1.2',
    '/modules/admin-dashboard.js?v=2.1.2',
    '/modules/conductor-dashboard.js?v=2.1.2',
    '/modules/report-s13.js?v=2.1.2',
    '/modules/analytics-view.js?v=2.1.2',
    '/modules/utils/helpers.js?v=2.1.2',
    '/modules/utils/intelligence.js?v=2.1.2',
    '/modules/map-viewer.js?v=2.1.2',
    '/modules/utils/theme-manager.js?v=2.1.2',
    '/favicon.svg',
    '/icon-192.svg',
    '/icon-512.svg'
];
