const CACHE_NAME = 'territorios-hard-sync-v2.4.0.7';

const ASSETS_CORE = [
    '/',
    '/index.html',
    '/styles.css?v=2.4.0.7',
    '/app.js?v=2.4.0.7',
    '/manifest.json',
    '/firebase-config.js?v=2.4.0.7',
    '/data/firestore-services.js?v=2.4.0.7',
    '/modules/login.js?v=2.4.0.7',
    '/modules/admin-dashboard.js?v=2.4.0.7',
    '/modules/conductor-dashboard.js?v=2.4.0.7',
    '/modules/report-s13.js?v=2.4.0.7',
    '/modules/analytics-view.js?v=2.4.0.7',
    '/modules/utils/helpers.js?v=2.4.0.7',
    '/modules/utils/intelligence.js?v=2.4.0.7',
    '/modules/map-viewer.js?v=2.4.0.7',
    '/modules/utils/theme-manager.js?v=2.4.0.7',
    '/modules/utils/pwa-manager.js?v=2.4.0.7',
    '/favicon.svg',
    '/icon-192.svg',
    '/icon-512.svg'
];
