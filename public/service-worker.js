...
const ASSETS_CORE = [
    '/',
    '/index.html',
    '/styles.css?v=1.9.8.6',
    '/app.js?v=1.9.8.6',
    '/manifest.json',
    '/firebase-config.js?v=1.9.8.6',
    '/data/firestore-services.js?v=1.9.8.6',
    '/modules/login.js?v=1.9.8.6',
    '/modules/admin-dashboard.js?v=1.9.8.6',
    '/modules/conductor-dashboard.js?v=1.9.8.6',
    '/modules/report-s13.js?v=1.9.8.6',
    '/modules/analytics-view.js?v=1.9.8.6',
    '/modules/utils/helpers.js?v=1.9.8.6',
    '/modules/utils/intelligence.js?v=1.9.8.6',
    '/modules/map-viewer.js?v=1.9.8.6',
    '/modules/utils/theme-manager.js?v=1.9.8.6',
    '/favicon.svg',
    '/icon-192.svg',
    '/icon-512.svg'
];
