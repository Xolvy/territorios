...
const ASSETS_CORE = [
    ...
    '/data/firestore-services.js?v=2.2.1',
    '/modules/login.js?v=2.2.1',
    '/modules/admin-dashboard.js?v=2.2.1',
    '/modules/conductor-dashboard.js?v=2.2.1',
    '/modules/report-s13.js?v=2.2.1',
    '/modules/analytics-view.js?v=2.2.1',
    '/modules/utils/helpers.js?v=2.2.1',
    '/modules/utils/intelligence.js?v=2.2.1',
    '/modules/map-viewer.js?v=2.2.1',
    '/modules/utils/theme-manager.js?v=2.2.1',
    '/favicon.svg',
    '/icon-192.svg',
    '/icon-512.svg'
];
