const CACHE_NAME = 'territorios-jw-v3.6.9';
const ASSETS_TO_CACHE = [
    ...
    '/app.js?v=3.6.9',
    '/manifest.json',
    '/firebase-config.js?v=3.6.9',
    '/data/firestore-services.js?v=3.6.9',
    '/modules/login.js?v=3.6.9',
    '/modules/admin-dashboard.js?v=3.6.9',
    '/modules/conductor-dashboard.js?v=3.6.9',
    '/modules/report-s13.js?v=3.6.9',
    '/modules/analytics-view.js?v=3.6.9',
    '/modules/utils/helpers.js?v=3.6.9',
    '/modules/utils/intelligence.js?v=3.6.9',
    '/modules/map-viewer.js?v=3.6.9',
    '/modules/utils/theme-manager.js?v=3.6.9',
    '/favicon.svg',
    '/icon-192.svg',
    '/icon-512.svg',
    '/public/favicon.svg',
