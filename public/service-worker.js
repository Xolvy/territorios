const CACHE_NAME = 'territorios-jw-v1.9.5.1';
const ASSETS_TO_CACHE = [
    '/',
    '/index.html',
    '/styles.css?v=1.9.5.1',
    '/app.js?v=1.9.5.1',
    '/manifest.json',
    '/firebase-config.js?v=1.9.5.1',
    '/data/firestore-services.js?v=1.9.5.1',
    '/modules/login.js?v=1.9.5.1',
    '/modules/admin-dashboard.js?v=1.9.5.1',
    '/modules/conductor-dashboard.js?v=1.9.5.1',
    '/modules/report-s13.js?v=1.9.5.1',
    '/modules/analytics-view.js?v=1.9.5.1',
    '/modules/utils/helpers.js?v=1.9.5.1',
    '/modules/utils/intelligence.js?v=1.9.5.1',
    '/modules/map-viewer.js?v=1.9.5.1',
    '/modules/utils/theme-manager.js?v=1.9.5.1',
    '/favicon.svg',
    '/icon-192.svg',
    '/icon-512.svg',
    '/public/favicon.svg',
