const CACHE_NAME = 'territorios-elite-v2.1.6';
...
const ASSETS_CORE = [
    ...
    '/app.js?v=2.1.6',
    '/manifest.json',
    '/firebase-config.js?v=2.1.6',
    '/data/firestore-services.js?v=2.1.6',
    '/modules/login.js?v=2.1.6',
    '/modules/admin-dashboard.js?v=2.1.6',
    '/modules/conductor-dashboard.js?v=2.1.6',
    '/modules/report-s13.js?v=2.1.6',
    '/modules/analytics-view.js?v=2.1.6',
    '/modules/utils/helpers.js?v=2.1.6',
    '/modules/utils/intelligence.js?v=2.1.6',
    '/modules/map-viewer.js?v=2.1.6',
    '/modules/utils/theme-manager.js?v=2.1.6',
    '/favicon.svg',
    '/icon-192.svg',
    '/icon-512.svg'
];
