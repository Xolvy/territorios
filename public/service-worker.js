const CACHE_NAME = 'territorios-hard-sync-v2.3.8';
...
const ASSETS_CORE = [
    ...
    '/app.js?v=2.3.8',
    '/manifest.json',
    '/firebase-config.js?v=2.3.8',
    '/data/firestore-services.js?v=2.3.8',
    '/modules/login.js?v=2.3.8',
    '/modules/admin-dashboard.js?v=2.3.8',
    '/modules/conductor-dashboard.js?v=2.3.8',
    '/modules/report-s13.js?v=2.3.8',
    '/modules/analytics-view.js?v=2.3.8',
    '/modules/utils/helpers.js?v=2.3.8',
    '/modules/utils/intelligence.js?v=2.3.8',
    '/modules/map-viewer.js?v=2.3.8',
    '/modules/utils/theme-manager.js?v=2.3.8',
    '/modules/utils/pwa-manager.js?v=2.3.8',
    '/favicon.svg',
    '/icon-192.svg',
    '/icon-512.svg'
];
