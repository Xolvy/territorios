const CACHE_NAME = 'territorios-premium-v1.9.9.0';

const ASSETS_CORE = [
    '/',
    '/index.html',
    '/styles.css?v=1.9.9.0',
    '/app.js?v=1.9.9.0',
    '/manifest.json',
    '/firebase-config.js?v=1.9.9.0',
    '/data/firestore-services.js?v=1.9.9.0',
    '/modules/login.js?v=1.9.9.0',
    '/modules/admin-dashboard.js?v=1.9.9.0',
    '/modules/conductor-dashboard.js?v=1.9.9.0',
    '/modules/report-s13.js?v=1.9.9.0',
    '/modules/analytics-view.js?v=1.9.9.0',
    '/modules/utils/helpers.js?v=1.9.9.0',
    '/modules/utils/intelligence.js?v=1.9.9.0',
    '/modules/map-viewer.js?v=1.9.9.0',
    '/modules/utils/theme-manager.js?v=1.9.9.0',
    '/favicon.svg',
    '/icon-192.svg',
    '/icon-512.svg'
];
