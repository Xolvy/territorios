const CACHE_NAME = 'territorios-elite-v2.1.0';
...
const ASSETS_CORE = [
    ...
    '/data/firestore-services.js?v=2.1.0',
    '/modules/login.js?v=2.1.0',
    '/modules/admin-dashboard.js?v=2.1.0',
    '/modules/conductor-dashboard.js?v=2.1.0',
    '/modules/report-s13.js?v=2.1.0',
    '/modules/analytics-view.js?v=2.1.0',
    '/modules/utils/helpers.js?v=2.1.0',
    '/modules/utils/intelligence.js?v=2.1.0',
    '/modules/map-viewer.js?v=2.1.0',
    '/modules/utils/theme-manager.js?v=2.1.0',
    '/favicon.svg',
    '/icon-192.svg',
    '/icon-512.svg'
];
