const CACHE_NAME = 'territorios-jw-v1.9.5.2';
const ASSETS_TO_CACHE = [
    '/',
    '/index.html',
    '/styles.css?v=1.9.5.2',
    '/app.js?v=1.9.5.2',
    '/manifest.json',
    '/firebase-config.js?v=1.9.5.2',
    '/data/firestore-services.js?v=1.9.5.2',
    '/modules/login.js?v=1.9.5.2',
    '/modules/admin-dashboard.js?v=1.9.5.2',
    '/modules/conductor-dashboard.js?v=1.9.5.2',
    '/modules/report-s13.js?v=1.9.5.2',
    '/modules/analytics-view.js?v=1.9.5.2',
    '/modules/utils/helpers.js?v=1.9.5.2',
    '/modules/utils/intelligence.js?v=1.9.5.2',
    '/modules/map-viewer.js?v=1.9.5.2',
    '/modules/utils/theme-manager.js?v=1.9.5.2',
    '/favicon.svg',
    '/icon-192.svg',
    '/icon-512.svg',
    '/public/favicon.svg',
