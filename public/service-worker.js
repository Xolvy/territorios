const CACHE_NAME = 'territorios-elite-v2.1.3';
...
const ASSETS_CORE = [
    ...
    '/app.js?v=2.1.3',
    '/manifest.json',
    '/firebase-config.js?v=2.1.3',
    '/data/firestore-services.js?v=2.1.3',
    '/modules/login.js?v=2.1.3',
    '/modules/admin-dashboard.js?v=2.1.3',
    '/modules/conductor-dashboard.js?v=2.1.3',
    '/modules/report-s13.js?v=2.1.3',
    '/modules/analytics-view.js?v=2.1.3',
    '/modules/utils/helpers.js?v=2.1.3',
    '/modules/utils/intelligence.js?v=2.1.3',
    '/modules/map-viewer.js?v=2.1.3',
    '/modules/utils/theme-manager.js?v=2.1.3',
    '/favicon.svg',
    '/icon-192.svg',
    '/icon-512.svg'
];
