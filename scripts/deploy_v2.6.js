...
async function run() {
    try {
        ...
        const newVersion = "2.6";
        console.log(`🚀 Updating system version to: v${newVersion} [NEXO AI INTEGRATION]`);
        ...
        await setDoc(doc(db, "configuracion", "version_control"), {
            ...
            changelog: "Sistema Nexo AI (v2.6) - Integración de Agente Universal Multimodal (Gemini), Interfaz de Voz y Control de Aplicación"
        }, { merge: true });
