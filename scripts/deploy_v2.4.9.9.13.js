...
async function run() {
    try {
        ...
        const newVersion = "2.4.9.9.13";
        console.log(`🚀 Updating system version to: v${newVersion} [VISUAL 2027 ENHANCED]`);
        ...
        await setDoc(doc(db, "configuracion", "version_control"), {
            ...
            changelog: "Xolvy Visual Engine 2027 - Renace la interfaz con Midnight Nebula"
        }, { merge: true });
