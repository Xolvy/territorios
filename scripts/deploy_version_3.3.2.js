...
async function run() {
    ...
    try {
        ...
        await setDoc(doc(db, "configuracion", "version_control"), {
            ...
            notes: "Actualización a v3.3.2: Módulo Telefónico Colapsable y Mejoras de UX"
        });
        console.log("✅ Versión remota actualizada con éxito en import { initializeApp } from "firebase/app";
import { getFirestore, doc, setDoc } from "firebase/firestore";
