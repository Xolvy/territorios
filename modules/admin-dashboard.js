...
import { formatPhoneNumber, getStatusColor, showNotification, formatMapUrl, ensureOnline, generatePlainXLS, formatManzanas } from './utils/helpers.js?v=2.2.3';
import { TerritoryIntelligence } from './utils/intelligence.js?v=2.2.3';

import { renderAnalyticsView } from './analytics-view.js?v=2.2.3';
import { getGlobalSettings, saveGlobalSettings } from '../data/firestore-services.js?v=2.2.3';
import { auth } from '../firebase-config.js?v=2.2.3';
import { animateEntry } from './utils/animations.js?v=2.2.3';
import { UIHelpers, showModal, showCustomConfirm, showCustomPrompt, showTerritorySelectionModal } from './services/ui-helpers.js?v=2.2.3';
import { GlassCard, GlassButton, GlassInput } from './services/ui-components.js?v=2.2.3';
import { renderCasaEnCasaTab } from './admin/territories-view.js?v=2.2.3';
import { renderAdvancedHistoryView, renderHistoryTab } from './report-s13.js?v=2.2.3';
...
// --- Replaced with shared helper in ui-helpers.js ---
        ...
        container.innerHTML = `
            <div class="space-y-12 animate-fade-in px-2 pb-32">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    <button id="hub-btn-assign" class="group relative bg-white dark:bg-[#12.2.3]/40 backdrop-blur-3xl overflow-hidden p-6 md:p-10 rounded-[2.5rem] border border-slate-200 dark:border-white/10 shadow-2xl transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_60px_-10px_rgba(59,130,246,0.3)]">
                    ...
                    <button id="hub-btn-return" class="group relative bg-white dark:bg-[#12.2.3]/40 backdrop-blur-3xl overflow-hidden p-6 md:p-10 rounded-[2.5rem] border border-slate-200 dark:border-white/10 shadow-2xl transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_60px_-10px_rgba(244,63,94,0.3)]">
                        ...
                        <div class="flex items-center gap-4 md:gap-6">
                            ...
                            <div class="text-left relative">
                                ...
                                ${selectedIds.size > 0 ? `<div class="absolute -top-4 -right-10 md:-top-6 md:-right-16 bg-rose-600 text-white w-8 h-8 md:w-10 md:h-10 rounded-full text-[12px] md:text-sm font-black flex items-center justify-center animate-bounce shadow-lg ring-4 ring-white dark:ring-[#12.2.3]">${selectedIds.size}</div>` : ''}
                            </div>
                        </div>
                    </button>
                </div>
...
// Note: renderProgramaTab was moved to modules/admin/territories-view.js
// to avoid duplication and state conflicts.
