...
import { auth } from '../firebase-config.js?v=2.3.9.1';
import { showNotification } from './utils/helpers.js?v=2.3.9.1';
import { GlassButton } from './services/ui-components.js?v=2.3.9.1';

// Import Views
import { renderAnalyticsView } from './analytics-view.js?v=2.3.9.1';
import { renderCasaEnCasaTab } from './admin/territories-view.js?v=2.3.9.1';
import { renderPredicacionTab } from './admin/public-view.js?v=2.3.9.1';
import { renderTelefonosTab } from './admin/phones-view.js?v=2.3.9.1';
import { renderConfigTab } from './admin/rules-view.js?v=2.3.9.1';
...
export const renderAdminDashboard = async (container, appVersion, initialTab = 'dashboard') => {
    try {
        ...
        window.editHistoryRecord = async (id) => {
            const { editHistoryRecord } = await import('./admin/history-view.js?v=2.3.9.1');
            await editHistoryRecord(id);
        };

        window.deleteHistoryRecordUI = async (id, cond, num) => {
            const { deleteHistoryRecordUI } = await import('./admin/history-view.js?v=2.3.9.1');
