    ...
    handleResize() {
        ...
        adaptiveContainers.forEach((container) => {
            ...
            if (isMobile) {
                ...
                children.sort((a, b) => {
                    const orderA = parseInt(a.getAttribute("data-mobile-order") || "999", 10);
                    const orderB = parseInt(b.getAttribute("data-mobile-order") || "999", 10);
                    return orderA - orderB;
                });
            } else {
                // Sort by data-desktop-order or original sequence
                children.sort((a, b) => {
                    const orderA = parseInt(a.getAttribute("data-desktop-order") || "0", 10);
                    const orderB = parseInt(b.getAttribute("data-desktop-order") || "0", 10);
                    return orderA - orderB;
                });
            }
