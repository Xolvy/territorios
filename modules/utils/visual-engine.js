...
export const VisualEngine = {
    ...
    components: {
        ...
        shell: {
            container:
                "min-h-screen bg-slate-100 dark:bg-[#0f172a] transition-colors duration-300 ease-out text-slate-900 dark:text-slate-100 tracking-tight",
        ...
        header: {
            wrapper:
                "bg-white dark:bg-[#1e293b] h-16 w-full px-6 flex items-center justify-between sticky top-0 z-[100]",
            glow: "hidden",
        },
        ...
        card: {
            ...
            premium:
                "bg-white dark:bg-[#1e293b] rounded-2xl border border-slate-100 dark:border-white/5 shadow-lg hover:shadow-xl transition-all duration-300",
