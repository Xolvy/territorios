...
const ensureInstallUI = () => {
    ...
    banner.className =
        "fixed bottom-24 left-4 right-4 md:bottom-12 md:left-auto md:right-8 md:w-[380px] glass-morphism p-6 rounded-[2.5rem] z-[1000] border border-teal-500/30 animate-bounce-in shadow-[0_20px_50px_rgba(13,148,136,0.3)] dark:shadow-none";
...
const showNotificationRationale = () => {
    ...
    rationale.className =
        "fixed top-40 left-4 right-4 md:left-auto md:right-8 md:w-96 glass-morphism p-6 rounded-[2.5rem] z-[110] border border-blue-500/30 animate-bounce-in shadow-2xl";
