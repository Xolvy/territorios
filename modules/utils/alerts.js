...
export const xDeleteConfirm = async (itemName) => {
    const result = await XolvyAlert.fire({
        ...
        customClass: {
            ...BASE_CLASSES,
            confirmButton: '!px-8 !py-4 !text-[10px] !font-black !uppercase !tracking-widest !rounded-2xl !bg-rose-600 !text-white hover:!bg-rose-700 !shadow-xl !shadow-rose-600/20',
        },
        preConfirm: () => {
