...
export const createThemeToggle = () => {
    ...
    btn.className = "fixed bottom-4 left-4 z-[9999] p-3 rounded-full bg-white/10 backdrop-blur-md border border-white/20 shadow-lg hover:scale-110 transition-all text-teal-400 group";
