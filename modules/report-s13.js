import { getHistorialReport, rebuildHistoryFromSchedule, getConfiguracion } from '../data/firestore-services.js?v=1.9.8.5';
import { showNotification, generatePlainXLS } from './utils/helpers.js?v=1.9.8.5';
    ...
    document.getElementById('btn-generate-report').addEventListener('click', async () => {
        ...
        try {
            const [allHistory, allTerritorios] = await Promise.all([
                ...
                import('../data/firestore-services.js?v=1.9.8.5').then(m => m.getTerritorios())
            ]);
