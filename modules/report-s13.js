        ...
        <div class="space-y-8 animate-fade-in">
            ...
            <div class="modern-card !p-6 flex flex-col lg:flex-row items-center gap-6 border-slate-200 dark:border-white/5 shadow-2xl bg-white dark:bg-white/[0.02]">
                ...
                <div class="flex flex-wrap items-center gap-4 bg-slate-50 dark:bg-black/20 p-4 rounded-2xl border border-slate-200 dark:border-white/10">
                    <div class="space-y-1">
                        <label class="text-[9px] font-black text-slate-600 dark:text-slate-400 uppercase tracking-widest ml-1">Año</label>
                    ...
                    <div class="space-y-1">
                        <label class="text-[9px] font-black text-slate-600 dark:text-slate-400 uppercase tracking-widest ml-1">Desde</label>
                    ...
                    <div class="space-y-1">
                        <label class="text-[9px] font-black text-slate-600 dark:text-slate-400 uppercase tracking-widest ml-1">Hasta</label>
                ...
                <div class="relative flex-1 min-w-0 group min-w-[200px] w-full lg:w-auto">
                    <span class="absolute left-5 top-1/2 -translate-y-1/2 text-slate-600 dark:text-slate-400 transition-colors group-focus-within:text-primary">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button id="cc-btn-tools" class="w-12 h-12 flex items-center justify-center bg-slate-100 dark:bg-white/5 text-slate-600 dark:text-slate-400 hover:text-primary rounded-xl border border-slate-200 dark:border-white/10 transition-all" title="Herramientas de Reconstrucción">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="modern-card !p-5 bg-white dark:bg-white/[0.02] border-slate-100 dark:border-white/5 shadow-lg group">
                    <p class="text-[9px] font-black uppercase tracking-[0.2em] text-slate-600 dark:text-slate-400 mb-2">Faltantes</p>
                    <div class="flex items-center gap-4">
                        <span id="cc-stat-missing" class="text-4xl font-black text-rose-500 tracking-tighter">0</span>
                        <div class="h-1.5 flex-1 min-w-0 bg-slate-100 dark:bg-white/5 rounded-full overflow-hidden">
                ...
                <div class="modern-card !p-5 bg-white dark:bg-white/[0.02] border-slate-100 dark:border-white/5 shadow-lg">
                    <p class="text-[9px] font-black uppercase tracking-[0.2em] text-slate-600 dark:text-slate-400 mb-2">Uso Frecuente</p>
                ...
                <div class="modern-card !p-5 bg-white dark:bg-white/[0.02] border-slate-100 dark:border-white/5 shadow-lg">
                    <p class="text-[9px] font-black uppercase tracking-[0.2em] text-slate-600 dark:text-slate-400 mb-2">Mayor Rezago</p>
                    <h4 id="cc-stat-oldest" class="text-2xl font-black text-orange-500 uppercase truncate">---</h4>
                    <p id="cc-stat-oldest-sub" class="text-[8px] font-bold uppercase tracking-widest mt-2 text-slate-600 dark:text-slate-400">Hace 0 días</p>
                </div>
            </div>
            ...
            <header class="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 border-b border-slate-100 dark:border-white/5 pb-8">
                <div class="flex items-center gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-[10px] text-slate-600 dark:text-slate-400 font-black uppercase tracking-[0.3em] mt-1 opacity-70">
                ...
                <div class="flex flex-wrap items-end gap-3 bg-slate-50 dark:bg-white/[0.02] p-5 rounded-3xl border border-slate-100 dark:border-white/5 shadow-inner">
                    <div class="space-y-2">
                         <label class="block text-[10px] uppercase text-slate-600 dark:text-slate-400 font-black tracking-widest ml-1">Año Servicio</label>
                    ...
                    <div class="space-y-2">
                        <label class="block text-[10px] uppercase text-slate-600 dark:text-slate-400 font-black tracking-widest ml-1">Desde</label>
                     ...
                     <div class="space-y-2">
                        <label class="block text-[10px] uppercase text-slate-600 dark:text-slate-400 font-black tracking-widest ml-1">Hasta</label>
