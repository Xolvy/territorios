        ...
        try {
            const steps = [
                ...
                },
                {
                    ...
                    text: "¿Necesitas ver un sector? Utiliza mi explorador para buscar manzanas o territorios específicos con una vista satelital técnica y precisa.",
                },
                {
            ...
            overlay.style.cssText =
                "position: fixed; inset: 0; background: rgba(15, 23, 42, 0.8); z-index: 999998; transition: opacity 0.5s; opacity: 0; pointer-events: auto;";

            // 3. Crear Highlight Box
            const highlightBox = document.createElement("div");
            highlightBox.id = "nexo-tour-highlight";
            highlightBox.style.cssText =
                "position: absolute; border: 2px solid #10B981; border-radius: 16px; box-shadow: 0 0 0 9999px rgba(15, 23, 42, 0.8), 0 0 30px rgba(16, 185, 129, 0.5); transition: all 0.5s cubic-bezier(0.4, 0, 0.2, 1); z-index: 999998; pointer-events: none;";

            // 4. Crear Tooltip (Inyección directa al Body)
            const tooltip = document.createElement("div");
            tooltip.id = "nexo-tour-tooltip";
            tooltip.style.cssText =
                "position: fixed; z-index: 999999; background: white; color: #333; padding: 24px; border-radius: 20px; box-shadow: 0 20px 50px rgba(0,0,0,0.5); min-width: 280px; max-width: 350px; transition: all 0.5s cubic-bezier(0.4, 0, 0.2, 1); opacity: 0; transform: scale(0.9); font-family: sans-serif;";
