...
import { formatPhoneNumber, getStatusColor, showNotification, formatMapUrl } from './utils/helpers.js?v=3.7.1.1';
import { TerritoryIntelligence } from './utils/intelligence.js?v=3.7.1.1';
import { MapViewer } from './map-viewer.js?v=3.7.1.1';
...
const loadUnifiedDashboard = async (name, agendaContainer, territoriosContainer, userMods, config) => {
    ...
    if (!hasShifts) {
        agendaContainer.innerHTML = `
            <div class="col-span-full py-24 px-8 modern-card text-center animate-fade-in shadow-2xl bg-slate-50 border-slate-200 opacity-60">
