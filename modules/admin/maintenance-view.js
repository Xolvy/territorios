...
import { ensureOnline, formatDateId } from '../utils/helpers.js?v=2.3';
import { showNotification, showCustomConfirm, showCustomPrompt } from '../services/ui-helpers.js?v=2.3';
...
export const renderMaintenanceTab = async (container, config, appVersion) => {
    ...
    bind('btn-smart-repair', async (btn) => {
        ...
        try {
            ...
            const { runSystemDiagnosticsAndRepair } = await import('../../data/firestore-services.js?v=2.3');
