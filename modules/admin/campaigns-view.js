import { getCampanas, saveCampana, deleteCampana } from '../../data/firestore-services.js?v=2.4.0.4';
import { showCustomConfirm, showCustomPrompt } from '../services/ui-helpers.js?v=2.4.0.4';
