import { getCampanas, saveCampana, deleteCampana } from '../../data/firestore-services.js?v=2.3.9';
import { showCustomConfirm, showCustomPrompt } from '../services/ui-helpers.js?v=2.3.9';
