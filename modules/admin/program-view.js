...
import { UIHelpers, showModal, showTerritorySelectionModal } from '../services/ui-helpers.js?v=2.3.8';
...
export const renderProgramaTab = async (container) => {
    ...
    container.querySelector('#btn-s13-export').onclick = async () => {
        ...
        `;
        const { renderS13CommandCenter } = await import('../report-s13.js?v=2.3.8');
    ...
    window.syncAssignmentFromProg = (dayIdx, turnoId) => {
        ...
        `, (modal) => {
            ...
            modal.querySelector('#confirm-sync').onclick = async () => {
                ...
                const { assignTerritorio } = await import('../../data/firestore-services.js?v=2.3.8');
