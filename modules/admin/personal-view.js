...
import { showNotification, normalize, toTitleCase } from '../utils/helpers.js';
import { showModal, showCustomConfirm } from '../services/ui-helpers.js';
import { setAdminLivePool } from '../admin-dashboard.js';

export const renderPersonalTab = async (container, configData = null, appVersion = null) => {
                    ...
                    <div class="space-y-6 md:space-y-8">
                        ...
                        <div id="p-modules-section" class="enterprise-card !p-0 overflow-hidden transition-all duration-500">
                            ...
                            <div class="p-4 md:p-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
                                ${[
                { id: 'mod-agenda', label: 'Agenda Inteligente', icon: 'fa-calendar-day', checked: person?.modulos?.agenda !== false },
                { id: 'mod-programa', label: 'Cronograma de Salidas', icon: 'fa-clock', checked: person?.modulos?.programa !== false },
