import { auth, db } from '/firebase-config.js?v=2.5.3';
...
import { renderLogin } from './modules/login.js?v=2.5.4';
import { renderAdminDashboard } from './modules/admin-dashboard.js?v=2.5.4';
import { renderConductorDashboard } from './modules/conductor-dashboard.js?v=2.5.4';
import { getPermisosUsuario, getSystemVersion, migrateConductoresToPublicadores } from './data/firestore-services.js?v=2.5.4';
import { showNotification } from './modules/utils/helpers.js?v=2.5.4';
import { initTheme, createThemeToggle } from './modules/utils/theme-manager.js?v=2.5.4';
