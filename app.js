...
import { auth, db } from './firebase-config.js?v=3.6.9.6';
import { onAuthStateChanged, signInAnonymously } from "firebase/auth";
import { doc, onSnapshot } from "firebase/firestore";
import { renderLogin } from './modules/login.js?v=3.6.9.6';
import { renderAdminDashboard } from './modules/admin-dashboard.js?v=3.6.9.6';
import { renderConductorDashboard } from './modules/conductor-dashboard.js?v=3.6.9.6';
import { getPermisosUsuario, getSystemVersion, migrateConductoresToPublicadores } from './data/firestore-services.js?v=3.6.9.6';
import { showNotification } from './modules/utils/helpers.js?v=3.6.9.6';
import { initTheme, createThemeToggle } from './modules/utils/theme-manager.js?v=3.6.9.6';
import { initPWA } from './modules/utils/pwa-manager.js?v=3.6.9.6';
